...
namespace MEGAPos.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult RegisterSalesAdmin()
        {
 
            var role = context.Roles.First(x=>x.Name == "Sales Admin").Name;
            ...
            ViewBag.Roles = new SelectList(context.Roles.Select(x=>x.Name).ToList());
        ...
        public ActionResult RegisterSalesPerson()
        {
            ...
            var role = context.Roles.First(x => x.Name == "Sales Person").Name;
